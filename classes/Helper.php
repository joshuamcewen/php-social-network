...
class Helper {
	...
	// if the data is valid return an empty string, if the data is invalid return a help message
	public static function validateString($field, $minlength, $maxlength)
	{
	...
	// if the data is valid return an empty string, if the data is invalid return a help message
	public static function validateInt($field, $min, $max)
	{
	...
	public static function validatePattern($field, $pattern, $error) {
	...
	public static function validateEmail($email) {
		if(!(filter_var($email, FILTER_VALIDATE_EMAIL) && Helper::validateString($email, 1, 50) == "")) {
